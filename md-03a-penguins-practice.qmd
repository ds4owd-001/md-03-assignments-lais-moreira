...
penguins |> 
  filter(sex == "male", island == c("Dream", "Biscoe"))
```
...
penguins |> 
  filter(sex == "female", species == "Chinstrap", island == c("Dream", "Torgersen"))
```
...
#different from: (the comma works as an 'and')
